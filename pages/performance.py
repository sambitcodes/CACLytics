...
st.set_page_config(page_title = "Performance",page_icon="🦈",layout="wide",initial_sidebar_state="collapsed")
...
with st.container(border=True):
    ...
    left.title(":blue[_CAC_]Lytics :chart:")
...
with st.container():
    selected = option_menu(menu_title=None,options=["Playground", "EDA", "Preprocess", "Prediction", "Performance"],
                                icons=['house', "graph-up-arrow","cloud-upload","signal","gear"],menu_icon="cast",
                                default_index=4,orientation="horizontal",styles={"nav-link":
